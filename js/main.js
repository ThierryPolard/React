...
var Application = React.createClass({
	...
	changeAnnee: function (annee) {
		/* les fonctions sont définies, mais pas encore appellées*/
		this.setState({
			choixAnnee: annee
		});
	},
	...
	getInitialState: function () {
		/* initialisation. Pas indispensable, mais bonne pratique*/
		return {
			choixAnnee: 2005
		};
	},
...
ReactDOM.render(React.createElement(Application, { dates: dates, names: cleanedNames }), document.getElementById('myReactApp')); /* c'est ici que les fonctions sont appliquées, ici la fonciton render, puis indique l'endrouit ou elle sont envoyée*/
